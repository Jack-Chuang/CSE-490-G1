...
# I can use a relatively large size of learning rate and still hit the same accuracy as using a smaller learning rate,
# which means the entire neural network is more stable. Sometimes bigger learning rates even perform better than smaller 
# learning rates both on the train data and the test data.
